# Generated by Django 4.1.3 on 2022-11-20 23:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0021_remove_beefcowgroupingredients_beef_cow_group_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('beef_cow_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.beefcowgroup')),
